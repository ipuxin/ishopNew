            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        echo $form->field($model, 'ishot')->radioList([0 => '不热卖', 1 => '热卖'], ['class' => 'span8' ,'value'=>'1'] );
                        echo $form->field($model, 'istui')->radioList([0 => '不推荐', 1 => '推荐'], ['class' => 'span8']);
                        echo $form->field($model, 'ison')->radioList([0 => '下架', 1 => '上架'], ['class' => 'span8','value'=>'1']);

                        /*商品封面图片*/
                        echo $form->field($model, 'cover')->fileInput(['class' => 'span9']);
                        if (!empty($model->cover)):
                            ?>
                            <img src="<?= $model->cover; ?>-covermiddle">
                            <hr>
                            <?php
                        endif;
                        /*多个商品小图*/
