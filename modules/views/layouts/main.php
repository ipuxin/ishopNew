...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        ...
        <a class="brand" href="<?= yii\helpers\Url::to(['default/index']) ?>" style="font-weight:700;font-family:Microsoft Yahei">壹朴心商城 - 后台管理</a>
...
<div id="sidebar-nav">
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="<?= yii\helpers\Url::to(['manage/manages']); ?>">管理员列表</a></li>
