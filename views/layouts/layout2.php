                    ...
                    <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            foreach ((array)$this->params['menu'] as $menu):
                                ?>
                                <li class="dropdown">
                                    <a href="<?= yii\helpers\Url::to(['product/index', 'cateid' => $menu['cateid']]) ?>"
                ...
                <div class="col-xs-12 col-md-4 ">
                    ...
                    <div class="contact-info">
                        <div class="footer-logo">
                            <a href="<?= yii\helpers\Url::to(['index/index']) ?>"><img alt="logo" src="assets/images/logo.PNG" width="233" height="54"/></a>
                        </div><!-- /.footer-logo -->
                        ...
                        <div class="widget">
                            ...
                            <ul>
                                ...
                                foreach($this->params['hot'] as $pro):
                                    if($i==5)break;$i++;
                                    ?>
                                    <li><a href="<?= yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>">
                                            <?= $pro['title']?></a></li>
                                <?php endforeach ?>
                            </ul>
                        </div><!-- /.widget -->
...
<script>
    ...
    $(".express").hover(function () {
        ...
        if ($(this).attr('data') != 'ok') {
            $.get(
                '<?php echo yii\helpers\Url::to(['order/getexpress']) ?>',  //url
                {'expressno': $(this).attr('data')},                        //参数
                function (res) {                                            //请求成功后,执行的回调函数
                    var str = "";
                    if (res.message = 'ok') {
