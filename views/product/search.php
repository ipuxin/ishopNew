                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="<?= yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"
                                       class="thumb-holder">
                                        <img alt="" src="<?= $pro['cover'] ?>-picsmall"/>
                                    </a>
                                </div>
                                <div class="col-xs-8 col-sm-8 no-margin">
                    ...
                    <?php foreach ($hot as $pro): ?>
                        <div class="no-margin carousel-item product-item-holder hover size-medium">
                            <div class="product-item">
                                ...
                                <div class="body">
                                    <div class="title">
                                        <a href="<?= yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><?php echo $pro['title'] ?></a>
                                    </div>
                                </div>
                                <div class="prices">
                        ...
                        <div id="grid-view" class="products-grid fade tab-pane in active">
                                    ...
                                    <?php foreach ($all as $pro): ?>
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                ...
                                                <div class="image">
                                                    <img alt="" src="<?= $pro['cover'] ?>-covermiddle"/>
                                                </div>
                                                <div class="body">
                                                    <?php if ($pro['issale']): ?>
                                                        <div
                                                    ...
                                                    <div class="title">
                                                        <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>">
                                                            <?= mb_substr(htmlspecialchars_decode($pro['title']),0,20,"utf-8")  ?></a>
                                                    </div>
                                                </div>
                                                <div class="prices">
                                                    <?php if ($pro['issale']): ?>
                            ...
                            <div class="pagination-holder">
                                <div class="row">
                                    ...
                                    <!--                                            Showing <span>1-9</span> of <span>-->
                                    <?php //echo $count ?><!--</span> results-->
                                    <!--                                        </div>-->
                                    <!--                                    </div>-->
                                            ...
                                            <div class="no-margin col-xs-12 col-sm-3 price-area">
                                                <div class="right-clmn">
                                                    ...
                                                    <div class="availability"><label>库存:</label><span
                                                            class="available">  <?php echo $pro['num'] ?></span></div>
                                                    <a class="le-button"
