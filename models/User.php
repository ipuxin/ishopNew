...
class User extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['wbuid', 'required', 'message' => 'wbuid不能为空', 'on' => ['wbreg']],
            ['username', 'required', 'message' => '用户名不能为空', 'on' => ['reg', 'regbymail', 'qqreg','update','wbreg']],
            ['username', 'unique', 'message' => '用户已经被注册', 'on' => ['reg', 'regbymail', 'qqreg','update','wbreg']],
            ['openid', 'unique', 'message' => 'openid已经被注册', 'on' => ['reg', 'regbymail', 'qqreg','wbreg']],
            ...
            ['userpass', 'required', 'message' => '用户密码不能为空', 'on' => ['reg', 'login', 'regbymail', 'qqreg','wbreg','update']],
            ['repass', 'required', 'message' => '确认密码不能为空', 'on' => ['reg', 'qqreg','wbreg']],
            ['repass', 'compare', 'compareAttribute' => 'userpass', 'message' => '两次密码输入不一致', 'on' => ['reg', 'qqreg','wbreg']],
