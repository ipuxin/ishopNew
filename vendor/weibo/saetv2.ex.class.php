 ...
 * 和授权相关的类
 * 获取一个生命周期很短的code,
 * 通过这个code,获取accesstoken等,和授权有关的
 * 说明如何调用微博的API
...
class SaeTOAuthV2
{
    ...
    /**
     * @ignore
     * 把下面的code,拼接到这个后面,就可以得到access_token了
     */
     ...
     * @ignore
     * 请求微博登录页面的主URL
     * 在这个链接后拼接一些参数,用户登录授权后就可以拿到一个code,拿到后再传给上面的accessTokenURL.
     * authorize ['ɔ:θəraiz]
     * 基本翻译
     * vt. 批准，认可；授权给；委托代替
     * 网络释义
     ...
     * App Key($client_id)：3316020616
     * App Sercet($client_secret)：9bd96d18781e5401f73e247b784ea5f7
     */
