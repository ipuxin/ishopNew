                    ...
                    <?php foreach ($products as $product): ?>
                        <tr class="first">
                            <td>
                                ...
                                <a href="<?= yii\helpers\Url::to(['product/mod', 'productid' => $product->productid]) ?>"
                                   class="name" target="_blank"><?php echo $product->title; ?></a>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php $isSale = ['不促销', '促销'] ?>
                                <?php echo $isSale[$product->issale]; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php $isOn = ['下架', '上架'] ?>
                                <?php echo $isOn[$product->ison]; ?>
                            </td>
                            <td>
                                <?php $isTui = ['不推荐', '推荐'] ?>
                                <?php echo $isTui[$product->istui]; ?>
                            </td>

                            <td class="align-right">
                                <a href="<?= yii\helpers\Url::to(['product/mod', 'productid' => $product->productid]); ?>">编辑</a>
                                <a href="<?= yii\helpers\Url::to(['product/on', 'productid' => $product->productid]); ?>">上架</a>
                                <a href="<?= yii\helpers\Url::to(['product/off', 'productid' => $product->productid]); ?>">下架</a>
                                <a href="<?= yii\helpers\Url::to(['product/del', 'productid' => $product->productid]); ?>">删除</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
