                    ...
                    <?php foreach($users as $user): ?>
                        <tr class="first">
                            <td>
                                ...
                                <?php endif; ?>
                                <a href="<?= yii\helpers\Url::to(['user/edit','userId'=>$user->userid])?>" class="name" onclick="common.add()"><?php echo $user->username; ?></a>
                            ...
                            <td class="align-right">
                                <a
                                    id="ipuxinDel" href="javascript:;" title="<?= $user->username; ?>"
                                    data-message="删除"
                                    data-id="<?= $user->userid; ?>"
                                    data-url="<?= yii\helpers\Url::to(['user/del', 'userid' => $user->userid]); ?>"
